...
!(function(f) {
    ...
    var regexs = {
        ...
        /**
         * @descrition:判断输入的参数是否是个合格的固定电话号码或传真号码。
         * 待验证的固定电话号码。
         * 国家代码(2到3位)-区号(2到3位)-电话号码(7到8位)-分机号(3位)
         * 例 0591-22958888、0591-22958888-222、086-22958888、086-22958888-221、086-22958888-221、086-0591-22958888-222
         **/
         ...
         * 16段：165、166
         * 17段：170、171、172、173、174、175、176、177、178、179
         * 18段：180、181、182、183、184、185、186、187、188、189
         * 19段：198、199
         * 国际码 如：中国(+86)
         */
        phone: /^((\+?[0-9]{1,4})|(\(\+86\)))?(13[0-9]|14[5-9]|15[0-9]|16[56]|17[0-9]|18[0-9]|19[89])\d{8}$/,
        /**
         * @descrition 匹配 URL 只检查协议
         *例 'http://www.xxx.com'
         */
        url: /[a-zA-z]+:\/\/[^\s]/,
        money: /^(0|[1-9]\d*)(\.\d+)?$/,
